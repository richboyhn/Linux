...
# Proxy SOCKS5 trên các cổng từ 22000 đến 22700 cho các địa chỉ IP khác nhau
$(for IP in "${IPS[@]}"; do
    for port in {22000..22004}; do
...
gen_data() {
    IPS=("103.161.17.35" "103.161.17.45" "103.161.17.50" "103.161.17.51" "103.161.17.151")
    FIRST_PORT=22000
    LAST_PORT=22004
    for IP in "${IPS[@]}"; do
